        ...
        <div class="col-12 col-md-10 p-4">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>List LOP</li>
                </ol>
            </nav>
                        ...
                        @foreach($lops as $l)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if((int)($l->has_diff ?? 0) === 0)
                                        <span class="text-success" title="Tidak ada selisih">
                                            <i class="fas fa-circle-check"></i>
                                        </span>
                                    @else
                                        <span class="text-danger" title="Ada selisih">
                                            <i class="fas fa-circle-xmark"></i>
                                        </span>
                                    @endif
                                </td>
                                <td class="text-center">
                                    <a href="{{ route('rekon.detail', [$project->id, $mitra, $l->lop_name]) }}" class="btn btn-sm btn-primary">
